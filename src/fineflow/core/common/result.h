#ifndef FINEFLOW_CORE_COMMON_RESULT_MACRO_HPP_
#define FINEFLOW_CORE_COMMON_RESULT_MACRO_HPP_
...
#define RET_NAME_IMPL(counter, line) FF_PP_CONCAT_WITH_3(_, _ret, counter, line)
